    ...
    public class MenuViewController
    {
        ...
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                CreateMenuGroup("Системный прокси", new MenuItem[] {
                    this.disableItem = CreateMenuItem("Отключить", new EventHandler(this.EnableItem_Click)),
                    this.PACModeItem = CreateMenuItem("PAC", new EventHandler(this.PACModeItem_Click)),
                    this.globalModeItem = CreateMenuItem("Глобально", new EventHandler(this.GlobalModeItem_Click))
                }),
                this.ServersItem = CreateMenuGroup("Серверы", new MenuItem[] {
                    this.SeperatorItem = new MenuItem("-"),
                    this.ConfigItem = CreateMenuItem("Редактировать", new EventHandler(this.Config_Click)),
                    new MenuItem("-"),
                    //CreateMenuItem("Поделиться", new EventHandler(this.QRCodeItem_Click)),
                    //CreateMenuItem("Сканировать QR с экрана", new EventHandler(this.ScanQRCodeItem_Click)),
                    //CreateMenuItem("Импортировать URL из буфера обмена", new EventHandler(this.ImportURLItem_Click))
                }),
                CreateMenuGroup("PAC ", new MenuItem[] {
                    this.localPACItem = CreateMenuItem("Локальный PAC", new EventHandler(this.LocalPACItem_Click)),
                    this.onlinePACItem = CreateMenuItem("Удаленный PAC", new EventHandler(this.OnlinePACItem_Click)),
                    new MenuItem("-"),
                    this.editLocalPACItem = CreateMenuItem("Изменить локальный PAC", new EventHandler(this.EditPACFileItem_Click)),
                    //this.updateFromGeositeItem = CreateMenuItem("Обновить локальный PAC из Geosite", new EventHandler(this.UpdatePACFromGeositeItem_Click)),
                    //this.editGFWUserRuleItem = CreateMenuItem("Изменить правила для Geosite", new EventHandler(this.EditUserRuleFileForGeositeItem_Click)),
                    //this.secureLocalPacUrlToggleItem = CreateMenuItem("Защитить локальный PAC", new EventHandler(this.SecureLocalPacUrlToggleItem_Click)),
                    //this.regenerateLocalPacOnUpdateItem = CreateMenuItem("Сбросить локальный PAC при обновлении", new EventHandler(this.RegenerateLocalPacOnUpdateItem_Click)),
                    //CreateMenuItem("Копировать URL локального PAC", new EventHandler(this.CopyLocalPacUrlItem_Click)),
                    this.editOnlinePACItem = CreateMenuItem("Изменить URL удаленного PAC", new EventHandler(this.UpdateOnlinePACURLItem_Click)),
                }),
                this.onlineConfigItem = CreateMenuItem("Подписки", new EventHandler(this.OnlineConfig_Click)),
                new MenuItem("-"),
                this.AutoStartupItem = CreateMenuItem("Запускать с Windows", new EventHandler(this.AutoStartupItem_Click)),
                this.proxyItem = CreateMenuItem("Обратный прокси", new EventHandler(this.proxyItem_Click)),
                //this.ProtocolHandlerItem = CreateMenuItem("Открывать ссылки ss://", new EventHandler(this.ProtocolHandlerItem_Click)),
                //this.ShareOverLANItem = CreateMenuItem("Поделиться подключением по LAN", new EventHandler(this.ShareOverLANItem_Click)),
                new MenuItem("-"),
                //this.hotKeyItem = CreateMenuItem("Горячие клавиши", new EventHandler(this.hotKeyItem_Click)),
                CreateMenuGroup("Помощь", new MenuItem[] {
                    CreateMenuItem("Показать журнал", new EventHandler(this.ShowLogItem_Click)),
                    this.VerboseLoggingToggleItem = CreateMenuItem( "Досканальное логирование", new EventHandler(this.VerboseLoggingToggleItem_Click) ),
                    ...
                    CreateMenuGroup("Обновления", new MenuItem[] {
                        CreateMenuItem("Проверить обновления", new EventHandler(this.checkUpdatesItem_Click)),
                        new MenuItem("-"),
                        this.autoCheckUpdatesToggleItem = CreateMenuItem("Проверять при запуске", new EventHandler(this.autoCheckUpdatesToggleItem_Click)),
                        this.checkPreReleaseToggleItem = CreateMenuItem("Устанавливать beta-версии", new EventHandler(this.checkPreReleaseToggleItem_Click)),
                    }),
                }),
                new MenuItem("-"),
                CreateMenuItem("Выход", new EventHandler(this.Quit_Click))
            });
        }
