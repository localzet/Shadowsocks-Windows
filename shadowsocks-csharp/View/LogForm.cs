...
namespace Shadowsocks.View
{
    public partial class LogForm : Form
    {
        ...
        private void UpdateTexts()
        {
            ...
            trafficChart.Series["Inbound"].LegendText = I18N.GetString("Входящий трафик");
            trafficChart.Series["Outbound"].LegendText = I18N.GetString("Исходящий трафик");
        }
        ...
        {
            this.Text = I18N.GetString("Просмотр журнала") +
                        $" [вход: {Utils.FormatBytes(controller.InboundCounter)}, выход: {Utils.FormatBytes(controller.OutboundCounter)}]";
